...
const inititalState = {
    url: "https://https://baotintuc.vn/am-thuc.rss",
    loading: true,
    data:[],
    errorMessage:null,
    dataGrid:[],
...
const AmThucNewsReducer = (state, action) => {
    switch (action.type) {
        case "SET_LOADING":
            return {...sate, loading: action.payload};
        case "SET_URL":
...
const AmThuc = () => {
    const [state, dispatch] = React.useReducer(AmThucNewsReducer, inititalState);
    async function fetchData(){
        try{
            ...
            dispatch({ type: "SET_DATA_SECTION", payload: dataSection.slice(0, 30) });
            ...
            <div className="margin_top5rem ">
                ...
                <div>
                    <ul className="flex justify-center">
                        <li className="">
                            <a className="block py-3 px-6 border-b-2 border-transparent text-lg" style={{color:"red"}} href="../am-thuc">Ẩm thực </a>
                        </li>
                        <li className="">
                ...
                <div className="bg-white py-6">
                    <div className="xl:container mx-auto px-3 sm:px-4 xl:px-2">
                        <div className="flex flex-row flex-wrap">
                            ...
                            <PopularPosts dataPopularPost={state.dataPopularPost}></PopularPosts>
                        </div>
                    </div>
                </div>
